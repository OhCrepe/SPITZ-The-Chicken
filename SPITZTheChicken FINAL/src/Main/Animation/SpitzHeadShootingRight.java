...
public class SpitzHeadShootingRight extends Animation{

	public SpitzHeadShootingRight(){
		this.frameDelay = 6;
		this.totalFrames = 1;
		this.frame = 0;
		this.delayCounter = 6;
		...
		try {
			this.sprites[0] = ImageIO.read(new File("resources/sprites/Entities/SPITZ/Head/Shooting/SPITZHeadRightOpen.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
